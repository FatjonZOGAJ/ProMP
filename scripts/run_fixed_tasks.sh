...
# FIXED 30, 75, 150, 300
#  RL2
python3 run_scripts/rl_run_out_of_sample.py --env AntRandGoalEnv --meta_batch_size 100 --n_itr 500 --exp_name fixed_ant_n_tasks_150 --fixed_tasks 1 --n_fixed_tasks 150 --seed 1 --eval_oos 1 --num_eval_grad_steps 1
python3 run_scripts/rl_run_out_of_sample.py --env AntRandGoalEnv --meta_batch_size 100 --n_itr 500 --exp_name fixed_ant_n_tasks_30  --fixed_tasks 1 --n_fixed_tasks 30  --seed 1 --eval_oos 1 --num_eval_grad_steps 1
python3 run_scripts/rl_run_out_of_sample.py --env AntRandGoalEnv --meta_batch_size 100 --n_itr 500 --exp_name fixed_ant_n_tasks_75  --fixed_tasks 1 --n_fixed_tasks 75  --seed 1 --eval_oos 1 --num_eval_grad_steps 1
python3 run_scripts/rl_run_out_of_sample.py --env AntRandGoalEnv --meta_batch_size 100 --n_itr 500 --exp_name fixed_ant_n_tasks_300 --fixed_tasks 1 --n_fixed_tasks 300 --seed 1 --eval_oos 1 --num_eval_grad_steps 1
